...
>(({ className, ...props }, ref) => (
  ...
  >
    <CheckboxPrimitive.Indicator
      className={cn(
        "absolute items-center inset-0 -left-[1px]    text-transparent    data-[state=checked]:animate-reveal-in animate-reveal-out  overflow-hidden "
      )}
    >
