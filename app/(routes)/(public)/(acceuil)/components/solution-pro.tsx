      ...
      <Accordion type="single" collapsible className="w-full ">
        <AccordionItem value="item-1 ">
          ...
          <AccordionContent>
            ...
            dans nos ateliers <br /> Mise à disposition de metteur en main pour
            livraisons de VO et de VN <br />
            ...
            <br /> Lavages de parc d’exposition Accompagnement aux préparations
            de portes ouvertes
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            Depuis 2001, Netcars est devenu le partenaire incontournable de bon
            nombre de cabinets d’expertises et de compagnies d’assurance dans la
            gestion des sinistres suivants:
            <br />
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent>
            Prise en charge de présentations de nouveaux modèles, pour le compte
            de constructeurs automobiles : installation des véhicules,
        ...
        <AccordionItem value="item-5">
          ...
          <AccordionContent>
            Vous devez restituer votre véhicule en fin de leasing (buy-back) et
            vous redoutez l’étape du procès-verbal de restitution ?<br />
            Combien vous coutera cette bosse, ces rayures, cet impact sur le
            pare-brise ou cette tâche sur la moquette ?<br />
            Netcars vous propose une solution simple et économique de gestion de
            votre restitution.
            <br />
            Après analyse ou sur envoi de photos, nos experts vous adressent un
            devis de remise en état intégrant les réparations nécessaires :
