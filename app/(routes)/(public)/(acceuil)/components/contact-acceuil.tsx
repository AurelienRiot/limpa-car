...
const ContactAcceuil = () => {
  ...
  return (
    <>
      <div
        className="w-full  bg-fixed bg-center bg-no-repeat bg-cover shadow-lg sm:h-[1500px] h-[1300px] relative"
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center gap-4 py-10 mt-8 text-3xl rounded-sm px-14 bg-black/10 ">
            <Link
              href="tel:0000000000"
